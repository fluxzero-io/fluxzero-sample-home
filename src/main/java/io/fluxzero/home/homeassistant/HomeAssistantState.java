...
public record HomeAssistantState(String entityId, String state, JsonNode attributes) {
    static HomeAssistantState from(JsonNode value) {
    ...
    Set<Capability> capabilities() {
        return switch (domain()) {
            case "light" -> supportsBrightness() ? Set.of(Capability.POWER, Capability.LIGHT_LEVEL) : Set.of(Capability.POWER);
    ...
    List<HomeAssistantAction> actions(DeviceSettings desired) {
        ...
        if (power == null && level == null) return List.of();
