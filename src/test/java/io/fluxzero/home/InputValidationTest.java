...
class InputValidationTest {
    static Stream<Arguments> invalidInputs() {
        ...
        return Stream.of(
                ...
                arguments("weekly days must be present", "timing.days", routine(new RoutineTiming.Weekly(null, LocalTime.NOON))),
                arguments("weekly cannot contain a null day", "timing.days",
                        routine(new RoutineTiming.Weekly(Collections.singleton(null), LocalTime.NOON))),
                arguments("weekly needs a local time", "timing.time", routine(new RoutineTiming.Weekly(Set.of(DayOfWeek.MONDAY), null))),
